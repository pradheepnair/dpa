 ...
 */
    ...
    function dpa_register_style() {
        ...
        wp_enqueue_style('dpa_css_style', DPA_THEME_URI . '/assets/css/style.css', false, '5.4.2');
    }
    ...
    function dpa_register_scripts() {
        ...
        wp_enqueue_script('dpa_script_custom', DPA_THEME_URI . '/assets/js/script.js', NULL, '1.1.4', true); 
