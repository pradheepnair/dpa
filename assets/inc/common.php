 ...
 */
    ...
    function dpa_register_scripts() {
        ...
        wp_localize_script('dpa_script_local', 'dpa_ajax', array('ajax_url' => admin_url('admin-ajax.php'), 'template_url' => DPA_THEME_URI), true); 
        wp_enqueue_script('dpa_script_custom', DPA_THEME_URI . '/assets/js/script.js', NULL, '1.1.1', true);  
    }
