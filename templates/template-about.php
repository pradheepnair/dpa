...
?>
<section class="about-us pt-6" style="background-image:url(<?php echo DPA_THEME_URI; ?>/assets/images/2023/bg/background_pattern.png); background-position:bottom right;">
    <div class="container">
